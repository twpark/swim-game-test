...
//    public final static String SERVER_HOSTNAME = "pomato.kaist.ac.kr";
    public final static String SERVER_HOSTNAME = "192.168.0.57";
    public final static int SERVER_PORT = 31342;
    public final static int SRC_PORT = 31343;
    public final static int CLIENT_PORT = 31344;

    public final static int DEFAULT_PPS = 10;
    public final static int DEFAULT_DURATION = 20;

    public final static String DEFAULT_PREFIX = "BURST";
