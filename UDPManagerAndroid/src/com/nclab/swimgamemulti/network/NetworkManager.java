...
public class NetworkManager {
    ...
    private String prefixString = "burst";
        ...
        public void run() {
            ...
            try {
                ...
                while (isReceiving) {
                    ...
                    if (packetType == PACKET_TYPE_REGSYNC_2) {
...
//                        Logger.d("Packet " + seq + " already received");
                            ...
                            String msg = "ReceivedPacket " + seq + " remoteNum= " + remoteSeq + " from= " + senderId + " latency= " + latency;
                            Logger.d(msg);
                            uiHandler.obtainMessage(GameActivity.MSG_DEBUG_VIEW_ADD, msg).sendToTarget();
                            ...
                            if (packetType == PACKET_BURST_START) {
                                ...
                                dataIn.read(prefixBuffer, 0, prefixSize);
                                String prefix = new String(prefixBuffer);
                                fileLogger.refreshLog("BURST-" + packetsPerSecond + "pps-" + prefix);
    ...
    public void sendBurst(String prefix) {
        try {
            DatagramSocket socket = getSenderSocket();
            ...
            dataOut.write(0);
            dataOut.writeInt(0);
            dataOut.writeInt(PACKET_BURST_START);
            dataOut.writeLong(0);
            dataOut.writeInt(0);
