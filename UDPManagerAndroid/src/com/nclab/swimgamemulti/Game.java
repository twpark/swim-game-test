...
public class Game implements Runnable {
    ...
    public static final int MSG_SET_PPS = 21;
    public static final int MSG_SET_DURATION = 22;
    public static final int MSG_SET_PREFIX = 23;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_SET_SERVER_ADDR:
                    ...
                    break;
                case MSG_SET_PPS:
                    mCommunicationManager.setPps((Integer)msg.obj);
                    break;
                case MSG_SET_DURATION:
                    mCommunicationManager.setDuration((Integer)msg.obj);
                    break;
                case MSG_SET_PREFIX:
                    mCommunicationManager.setPrefixString((String)msg.obj);
                    break;
            }
        }
    };
